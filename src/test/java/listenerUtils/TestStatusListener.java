...
public class TestStatusListener extends BasePage implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		log.error( methodName+ " Test Case Failed");
		extentTest.fail(methodName+ " Test Case Failed");
		try {
	...
	public void onTestSuccess(ITestResult result) {
		...
		extentTest.pass(methodName+ " Test Case Passed");
	}
	
	@Override
	public void onTestSkipped(ITestResult result) {
		String methodName = result.getName();
		log.info( methodName+ " Test Case Skipped");
		extentTest.pass(methodName+ " Test Case Skipped");
	}
